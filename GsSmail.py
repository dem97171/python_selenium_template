...
class GsSmail:
    ...
    def work(self):
        ...
        # ショートメールを開く
        self.driver.get('https://demo.groupsession.jp/gsession/common/cmn002.do?menuPage=1&url=../smail/sml010.do')
        time.sleep(2)

        # iframeに入る
        iframe = self.driver.find_element('name', 'body')
        self.driver.switch_to.frame(iframe)
        self.driver.find_element_by_id('mail_list_head_menu_area_tr').find_element_by_class_name('head_menu_add_btn').click()
        time.sleep(1)
